...
public final class MatchAnalyze {
  ...
  private static final double ACCEL_CEILING = 12.0; // DriveCommands slew limit, m/s^2
  private static final double BRAKE_BUDGET = 20.0; // DriveCommands limiter, m/s^2
