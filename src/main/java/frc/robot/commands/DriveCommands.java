...
public class DriveCommands {
   ...
   *
   * <p>The limit is asymmetric: only commands that reduce speed are limited. See {@link
  ...
  private static class ChassisAccelerationLimiter {
     ...
     */
    ChassisAccelerationLimiter(double maxAngularAcceleration) {
    ...
    ChassisSpeeds calculate(ChassisSpeeds desired) {
      ...
      double maxAngularDelta = maxAngularAcceleration * LOOP_PERIOD_SECS;
      omega =
          MathUtil.clamp(
  ...
  public static Command joystickDrive(
    ...
    ChassisAccelerationLimiter limiter = new ChassisAccelerationLimiter(MAX_ANGULAR_ACCELERATION);
  ...
  public static Command joystickDriveAtAngle(
    ...
    ChassisAccelerationLimiter limiter = new ChassisAccelerationLimiter(Double.POSITIVE_INFINITY);
