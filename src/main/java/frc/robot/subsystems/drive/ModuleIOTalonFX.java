...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    // Check freshness of cached signals without triggering a new CAN request.
    // refreshAll() blocks on a synchronous CAN round-trip; isAllGood() reads the
    // already-cached value updated at the configured 50 Hz rate — no bus traffic.
    var driveStatus =
