...
public class PrestageConstants {
  ...
  public static class CurrentLimits {
    ...
    public static final int PRESTAGE_MAIN_STATOR_AMP = 45;
  }
  ...
  public static class Mechanical {
    public static final double prestageRatio = 24.0 / 11.0;
  }

  // Real robot PID gains for torque-current velocity control
  public static class PID {
    public static final double KS = 8.0; // 8.0
    public static final double KV = 0.0; // 0.0
    public static final double KP = 8.0; // 13.0
  ...
  public static class prestageMagicConstants {
    public static final double prestageAccel = 100.0; // 80.0
  }
