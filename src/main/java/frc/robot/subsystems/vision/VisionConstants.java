...
public class VisionConstants {
  ...
  public static double maxAmbiguity =
      0.2; // was 0.4 — at 0.4 the wrong PnP solution is 40% as plausible, causing far-off
  // single-tag poses
  ...
  public static double linearStdDevBaseline =
      0.03; // Meters — was 0.01, which was too trusting (2cm std dev at 1m single-tag caused pose
  // yanking)
  ...
  // pose estimator.
  public static double singleTagStdDevMultiplier =
      4.0; // was 2.0 — single-tag PnP ambiguity warrants much lower trust than 2×
