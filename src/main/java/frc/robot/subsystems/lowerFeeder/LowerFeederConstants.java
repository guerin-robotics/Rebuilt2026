...
public class LowerFeederConstants {
  ...
  public static class CurrentLimits {
    ...
    public static final int LOWER_FEEDER_MAIN_STATOR_AMP = 40; // from 35
  }
  ...
  public static class feederMagicConstants {
    public static final double lowerFeederAccel = 200.0;
  }
  ...
  public static class Sim {
    ...
    public static final double LOWER_FEEDER_MOI = 0.001;
